...
jobs_queue_depth{otel_scope_name="github.com/jdziat/simple-durable-jobs/pkg/metrics",otel_scope_schema_url="",otel_scope_version="",outcome="pending",queue="default"} 3
Starting worker...
...
jobs_completed_total{job_type="metric-job",otel_scope_name="github.com/jdziat/simple-durable-jobs/pkg/metrics",otel_scope_schema_url="",otel_scope_version="",outcome="completed",queue="default"} 3
jobs_started_total{job_type="metric-job",otel_scope_name="github.com/jdziat/simple-durable-jobs/pkg/metrics",otel_scope_schema_url="",otel_scope_version="",outcome="started",queue="default"} 3
